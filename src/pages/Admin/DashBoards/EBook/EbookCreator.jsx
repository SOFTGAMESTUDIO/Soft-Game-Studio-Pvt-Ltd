...
const TiptapEditor = ({ content, onChange }) => {
  const editor = useEditor({
    ...
    content,
    onUpdate: ({ editor }) => {
      onChange(editor.getHTML()); // ✅ just send the HTML
    },
    editorProps: {
      attributes: {
        class:
...
const EbookCreator = () => {
  ...
  const removeChapter = (index) => {
    ...
    const updatedExpanded = expandedChapters.filter((i) => i !== index).map((i) => (i > index ? i - 1 : i));
  ...
  const saveEbook = async () => {
    ...
    try {
      ...
      setEbook({
        ...
        description: "",
        coverImageURL: "",
        chapters: [{ chapterNo: 1, title: "", content: "", resourceLinks: [""] }],
      });
    ...
    <Layout>
      <div className="max-w-6xl mx-auto p-4 bg-purple-50 dark:bg-neutral-950 min-h-screen">
        <div className="bg-white dark:bg-neutral-900 rounded-xl shadow-lg p-6 mb-8">
          <h1 className="text-3xl font-bold text-purple-800 dark:text-purple-400 mb-6">
            Create New eBook
          </h1>
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEbook({ ...ebook, coverImageURL: e.target.value })
                  }
                  className="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-neutral-800 text-gray-900 dark:text-white"
                        ...
                        <div className="space-y-2">
                          {chapter.resourceLinks.map((link, linkIndex) => (
                            <div key={linkIndex} className="flex items-center">
                              ...
                              <button
                                onClick={() =>
                                  removeResourceLink(index, linkIndex)
                                }
