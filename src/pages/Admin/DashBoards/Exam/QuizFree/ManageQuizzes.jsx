...
const ManageQuizzes = () => {
  ...
  const fetchQuizzes = async () => {
    try {
      const quizCollection = collection(fireDB, "quizzesfree");
          ...
          {loading ? (
            ...
            >
              ...
              <motion.button
                ...
                onClick={() => navigate("/Admin-QuizFree-Create")}
              >
                Create New Quiz
              </motion.button>
            </motion.div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap gap-2 mt-4">
                        <motion.button
                          ...
                          onClick={() => navigate(`/Admin-QuizFree-Edit-QuizDetails/${quiz.id}`)}
                        >
                          Edit Details
                        </motion.button>
                        <motion.button
                          ...
                          onClick={() => navigate(`/Admin-QuizFree-Edit-QuizQuestion/${quiz.id}`)}
                        >
                          Edit Questions
                        </motion.button>
                      </div>
